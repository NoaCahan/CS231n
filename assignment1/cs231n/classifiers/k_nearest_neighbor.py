...
class KNearestNeighbor(object):
  ...
  def compute_distances_no_loops(self, X):
    ...
    #print XY.shape, XX.shape, YY.shape
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in xrange(num_test):
      ...
      #########################################################################
      # other options for solving, but they are wrong!
      #x_sort = np.argsort(dists[i,:])
      #x_sort = x_sort[0:k]
      #closest_y = [self.y_train[num] for num in x_sort]
      ...
      # label.                                                                #
      #########################################################################
      hist, bin_edges = np.histogram(closest_y, bins=np.arange(11))
